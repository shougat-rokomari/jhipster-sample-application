...
class PersonResourceIT {
    ...
    void putNewPerson() throws Exception {
        ...
        updatedPerson.name(UPDATED_NAME).dateOfBirth(UPDATED_DATE_OF_BIRTH).dateOfDeath(UPDATED_DATE_OF_DEATH).gender(UPDATED_GENDER);
    ...
    void partialUpdatePersonWithPatch() throws Exception {
        ...
        partialUpdatedPerson.dateOfDeath(UPDATED_DATE_OF_DEATH);
